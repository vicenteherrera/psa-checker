...
| [iamalryz](https://iamalryz.github.io/helm-charts) | stolon | baseline | -36 | 0.4.1 | 0.16.0 |
...
| [ibm-helm](https://raw.githubusercontent.com/IBM/charts/master/repo/ibm-helm) | ibm-b2bi-prod | empty_no_object |  | 2.1.0 | 6.1.2.0 |
...
| [ibm-helm](https://raw.githubusercontent.com/IBM/charts/master/repo/ibm-helm) | ibm-object-storage-plugin | error_template |  | 2.2.2 | 2.2.2 |
...
| [ibm-helm](https://raw.githubusercontent.com/IBM/charts/master/repo/ibm-helm) | ibm-pem-standard-prod | baseline | -36 | 1.1.1 | 6.2.1.1 |
...
| [ibm-helm](https://raw.githubusercontent.com/IBM/charts/master/repo/ibm-helm) | ibm-sccd | baseline | -36 | 1.0.9 | V6.2.1.0-iFix07 - build May 18 2022 15:19 |
| [ibm-helm](https://raw.githubusercontent.com/IBM/charts/master/repo/ibm-helm) | ibm-sccm | baseline | -36 | 1.0.11 | V6.2.1.0_iFix08 - build September 13 2022 14:10 |
| [ibm-helm](https://raw.githubusercontent.com/IBM/charts/master/repo/ibm-helm) | ibm-seas | error_template |  | 1.2.5 | 6.0.3.0.04 |
...
| [ibm-helm](https://raw.githubusercontent.com/IBM/charts/master/repo/ibm-helm) | ibm-sfg-prod | empty_no_object |  | 2.1.0 | 6.1.2.0 |
...
| [ibm-helm](https://raw.githubusercontent.com/IBM/charts/master/repo/ibm-helm) | ibm-ssp-engine | empty_no_object |  | 1.2.5 | 6.0.3.0.04 |
| [ibm-helm](https://raw.githubusercontent.com/IBM/charts/master/repo/ibm-helm) | ibm-ssp-ps | error_template |  | 1.2.5 | 6.0.3.0.04 |
| [ibm-helm](https://raw.githubusercontent.com/IBM/charts/master/repo/ibm-helm) | ibm-ucd-prod | error_template |  | 8.0.2 | 7.2.3 |
| [ibm-helm](https://raw.githubusercontent.com/IBM/charts/master/repo/ibm-helm) | ibm-ucda-prod | error_template |  | 3.3.9 | 7.2.3 |
| [ibm-helm](https://raw.githubusercontent.com/IBM/charts/master/repo/ibm-helm) | ibm-ucdr-prod | error_template |  | 3.3.9 | 7.2.3 |
| [ibm-helm](https://raw.githubusercontent.com/IBM/charts/master/repo/ibm-helm) | ibm-ucv-prod | baseline | -84 | 2.4.21 | 2.4.2 |
...
| [ibm-odm-metering](https://raw.githubusercontent.com/DecisionsDev/decisions-metering/master/charts/stable) | ibm-odm-metering | empty_no_object |  | 22.1.0 | 8.11.0.1 |
| [icikowski](https://charts.icikowski.pl) | gpts | baseline | -12 | 0.7.7 | 0.7.7 |
| [ideaplexus-matomo](https://gitlab.com/api/v4/projects/21021774/packages/helm/stable) | matomo | baseline | -12 | 4.12.2+02 | 4.12.2 |
...
| [imagepullsecret-patcher](https://duckincyber.github.io/imagepullsecret-patcher-Helm/) | pullsecret-patcher | empty_no_object |  | 0.1.0 | v0.14 |
| [imgproxy](https://helm.imgproxy.net/) | imgproxy | baseline | -12 | 0.8.23 | 3.9.0 |
...
| [imytech](https://helm.imytech.net/) | webhook-broker-chart | baseline | -12 | 0.2.0-dev | v0.2.0-dev |
| [inaccel](https://setup.inaccel.com/helm) | fpga-operator | privileged | -43 | 2.8.0 | 2.1 |
| [inbucket](https://inbucket.github.io/inbucket-community) | inbucket | baseline | -25 | 2.0.1 | 3.0.0 |
| [indexer-application](https://tomibarreche.github.io/indexer-application/) | indexer-chart | baseline | -12 | 0.1.0 | 1.2.0 |
| [inertia-service](https://pipeacosta.github.io/helm-charts/) | inertia-demo | empty_no_object |  | 1.0.0 | 1.0.0 |
| [inesouledelhaj-jenkins-chart](https://inesouledelhaj.github.io/jenkins-chart/) | jenkins | baseline | -1 | 9.0.12 | 2.332.1 |
| [infinity-server](https://infinity-server.github.io/dockerset/) | cert-manager-webhook-acmesh | error_template |  | 1.3.0 | 1.2.0 |
| [infinity-server](https://infinity-server.github.io/dockerset/) | frpc-ingress | baseline | -12 | 0.2.2 | 0.2.2 |
...
| [infrabeats-agent](https://infrabeats.com/helm-charts/) | infrabeats-agent | baseline | 0 | 1.0.3 | 1.0.0 |
| [infracloudio](https://charts.botkube.io/) | botkube | baseline | -1 | 0.15.0 | v0.15.0 |
| [ingress-dashboard](https://taemon1337.github.io/ingress-dashboard/) | ingress-dashboard | baseline | -25 | 0.1.1 | 0.0.1 |
| [ingress-nginx-internal](https://namewee.github.io/ingress-nginx-internal) | ingress-nginx | baseline | -39 | 4.1.0 | 1.2.0 |
| [ingress-nginx](https://kubernetes.github.io/ingress-nginx) | ingress-nginx | baseline | -39 | 4.4.0 | 1.5.1 |
| [inlets](https://inlets.github.io/inlets-operator) | inlets-operator | baseline | -16 | 0.16.4 | 1.0 |
...
| [instana](https://agents.instana.io/helm) | instana-agent | no_pod_object | -10 | 1.2.47 | 1.233.0 |
| [instana](https://agents.instana.io/helm) | instana-autotrace-webhook | error_template |  | 1.237.5 | 1.237.5 |
| [instemming-registratie-component](https://raw.githubusercontent.com/ConductionNL/instemming-registratie-component/master/api/helm/) | irc | baseline | -24 | 1.0.0 | V1.0 |
| [instemmingservice](https://raw.githubusercontent.com/ConductionNL/instemmingservice/master/api/helm/) | instemmingservice | baseline | -24 | 1.0.0 | V1.0 |
...
| [intel](https://intel.github.io/helm-charts) | intel-device-plugins-dlb | empty_no_object |  | 0.25.0 | 0.25.0 |
| [intel](https://intel.github.io/helm-charts) | intel-device-plugins-dsa | empty_no_object |  | 0.25.0 | 0.25.0 |
| [intel](https://intel.github.io/helm-charts) | intel-device-plugins-gpu | empty_no_object |  | 0.25.0 | 0.25.0 |
| [intel](https://intel.github.io/helm-charts) | intel-device-plugins-iaa | empty_no_object |  | 0.25.0 | 0.25.0 |
| [intel](https://intel.github.io/helm-charts) | intel-device-plugins-operator | baseline | -3 | 0.25.0 | 0.25.0 |
| [intel](https://intel.github.io/helm-charts) | intel-device-plugins-qat | empty_no_object |  | 0.25.0 | 0.25.0 |
| [intel](https://intel.github.io/helm-charts) | intel-device-plugins-sgx | empty_no_object |  | 0.25.0 | 0.25.0 |
...
| [invoiceninja](https://invoiceninja.github.io/dockerfiles) | invoiceninja | baseline | 0 | 0.9.2 | 5.3.80 |
...
| [istio-official](https://istio-release.storage.googleapis.com/charts) | base | no_pod_object | -36 | 1.16.0-rc.0 | 1.16.0-rc.0 |
| [istio-official](https://istio-release.storage.googleapis.com/charts) | cni | privileged | -22 | 1.16.0-rc.0 | 1.16.0-rc.0 |
| [istio-official](https://istio-release.storage.googleapis.com/charts) | gateway | baseline | -1 | 1.16.0-rc.0 | 1.16.0-rc.0 |
| [istio-official](https://istio-release.storage.googleapis.com/charts) | istiod | baseline | -40 | 1.16.0-rc.0 | 1.16.0-rc.0 |
| [istio-ratelimit-operator](https://zufardhiyaulhaq.com/istio-ratelimit-operator/charts/releases/) | istio-ratelimit-operator | baseline | -2 | 2.8.0 | 2.8.0 |
| [istio-ratelimit](https://xyctruth.github.io/istio-ratelimit) | istio-ratelimit | baseline | -12 | 0.0.3 | 4d2efd61 |
...
| [iteratec](https://charts.security.iteratec.dev) | teamdojo | baseline | -12 | 2.0.1 | 2.0.1 |
| [iti-web-app](https://mohamedanwer006.github.io/helm-hol/charts) | webapp | baseline | -24 | 0.1.0 | 1.16.0 |
...
| [itsmethemojo](https://itsmethemojo.github.io/helm-charts/) | hetzner-dyndns | baseline | 0 | 0.1.1 | 0.0.1 |
| [ittrident-oss](https://ittrident.github.io/helm-charts/) | keyoxide-web | baseline | -12 | 0.2.3 | 1.16.0 |
| [ittrident-oss](https://ittrident.github.io/helm-charts/) | openproject | empty_no_object |  | 0.2.3 | 1.16.0 |
| [ivanov-oleg-charts](https://raw.githubusercontent.com/IvanovOleg/charts/main/) | hello-nodejs | baseline | -12 | 0.1.7 | latest |
